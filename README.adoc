...
. O projeto utiliza o https://maven.apache.org/wrapper/[Maven Wrapper,window=_blank], logo basta executar o comando Maven abaixo para realizar o build do projeto:
.. Linux/Mac:
+
[source, bash]
----
...
. Agora, caso tenha o Maven instalado em seu ambiente, então basta você executar o comando Maven abaixo para realizar o build do projeto:
+
[source, bash]
----
mvn clean verify
